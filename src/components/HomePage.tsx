...
import { Clock, Monitor, Cpu, Laptop, X, LogOut, PlusCircle, Wifi, Calendar, Power, Trash2, Check } from 'lucide-react';
...
const HomePage: React.FC<HomePageProps> = ({ onLogout }) => {
  const mockUser = {
    ...
    picture: "https://lh3.googleusercontent.com/a/ACg8ocLywKWUkmolnoQEJ3yAqHzx-EqxQ9chX48AMCgCCqy-3zCiEx3yjw=s360-c-no"
  };

  const [user, setUser] = useState(mockUser);
  const [clientInfo, setClientInfo] = useState<ClientInfo>({ ip: '192.168.1.100', mac: 'AA:BB:CC:DD:EE:FF' });
                      ...
                      <div className="absolute top-3 right-3 flex gap-2">
                        <label className="inline-flex items-center cursor-pointer">
                          <input 
                            ...
                            onChange={() => toggleDeviceStatus(device.mac, device.ip)}
                          />
                      ...
                      <div className="flex items-center mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            ...
                            <span className={`ml-2 ${device.status ? 'text-green-500' : 'text-red-500'}`}>
        ...
        {showPersonalForm && (
          ...
          >
            ...
            >
              ...
              <form onSubmit={handlePersonalSubmit} className="p-4 space-y-4 text-black">
                <div>
      ...
      <AnimatePresence>
        {confirmModal.isOpen && (
          <ConfirmationModal
            ...
            onConfirm={() => handleRevoke(confirmModal.deviceMac, confirmModal.deviceIp)}
